        ...
        <section id="one" className="main style1">
          <div className="grid-wrapper">
            <div className="col-6">
              ...
              <p>I studied Programming at the Fukuoka Institute of Technology and graduated with a bachelor’s degree in
                Information Technology in 2014.</p>
              <p>I began my career by working at a System Integration organization as a backend developer for 3
                years. </p>
              <p>I specialized in creating and implementing blueprints as well as writing programs for IoT, EC site, and
                financial site projects. </p>
              <p>I have lived in Vancouver, Canada since 2018, moving here in order to continue studying and developing
                mobile apps. </p>
            ...
            <div className="col-12">
              ...
              <div className="col-4">
                <span className="image"><img
                  src={'https://flycricket-screenshots.s3.amazonaws.com/4996c0a108de41fbad2c80dd2f6e8418/medium/fdfa8545-1305-447a-8bec-de376bebc035'}
                  alt="Top Page" height={200} width={150}/></span>
                <h3> Locatter </h3>
